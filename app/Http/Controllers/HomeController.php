...
class HomeController extends Controller
{
    ...
    public function dashboard(){
        ...
        $penyakit = Report::where('penyakit_id',6)->count();
        ...
        $chart2->dataset('1.penyakit v 2.Rosacea 3.Perioral 4.Pityrosporum 5.Keratos 6.Gram 7.Pseudo', 'bar', [strval($penyakit), strval($rosacea), strval($perioral),strval($pity),strval($keratos),strval($gram),strval($pseu)]);
        $chart2->options([
                        'scales' =>[
                            'yAxes' => [[
                                'ticks' => [
