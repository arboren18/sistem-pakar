        ...
        <div class="row">
            <div class="col-6 position-relative">
                <div class="position-absolute" style="top:30%;">
                    <h1>eCovid</h1>
                    <h6>Temukan solusi untuk permasalahan COVID-19 <br> yang anda alami</h6>
                    <a href="/#form-tes" class="shadow btn btn-primary mt-4">Coba Sekarang</a>
                </div>
            </div>
            <div class="col-6">
                <img class="img-fluid" src="https://img.freepik.com/free-vector/prevent-epidemic-rebound-concept-illustration_114360-3008.jpg?t=st=1717023098~exp=1717026698~hmac=00e1cf08109b257a51c8ea68c2f6a79c3064013cc246c89d2c7c5d6195f6807f&w=996" alt="">
            </div>
        </div>
    </div>
</div>
<div class="container my-4">
    <div class="row">
        <div class="col-md-4 pt-5">
            <h3>Kenali beberapa varian COVID-19</h3>
            <p>Kondisi ini berhubungan dengan infeksi virus yang dapat mempengaruhi paru-paru.</p>
        </div>
        <div class="col">
            <div class="row">
